        ...
        {smallScreen ? (
            ...
            >
                ...
                >
                    ...
                    <div
                    className="block relative hover:opacity-100 p-2 h-auto"
                    >
                        <h1
                        className={`text-xl 
                        ${darkMode ? "text-gray-200 hover:text-blue-200" : "text-gray-700 hover:text-blue-900"} 
                        opacity-75 
                        p-5`}
                        >Current Book:</h1>
                        <br/><br/><br/>
                        <a href="/books/:idBook"><div
                        className={`w-4/6 absolute right-3 bottom-2 flex space-x-5
                        items-center shadow-xl my-3 p-4 rounded
                        ${darkMode ? "hover:bg-slate-600" : "hover:bg-slate-400" }
                        ease-in-out duration-300 
                        hover:w-5/6`}
                        >
                        <img src="https://edit.org/photos/img/blog/t9i-edit-book-covers-online.jpg-840.jpg"
                        className="w-7 h-10"
                        />
                        <div
